...
import { fssaiRegistrationHeroHeadingData } from "../../data/LegalServicesPagesData/FSSAIRegistration/fssaiRegistrationHeroHeadingData";

function FSSAIRegistration() {
  return (
    <div>
      <HeroHeading data={fssaiRegistrationHeroHeadingData.data} />
