...
import { isoCertificationHeroHeadingData } from "../../data/LegalServicesPagesData/ISOCertification/isoCertificationHeroHeadingData";

function ISOCertification() {
  return (
    <div>
      <HeroHeading data={isoCertificationHeroHeadingData.data} />
