...
import { gstRegistrationHeroHeadingData } from "../../data/LegalServicesPagesData/GSTRegistration/gstRegistrationHeroHeading";

function GSTRegistration() {
  return (
    <div>
      <HeroHeading data={gstRegistrationHeroHeadingData.data} />
